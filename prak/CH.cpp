...
// вспомогательная структура, которая описывает точку
...
struct DataPoints
{
	...
	double S, er;
	double h;
	int sub; // Признак изменения шага
	DataPoints()
	{
		num = 0;
...
//двойной счет с половиным шагом 
//функция возвращает результат вычислений в виде вектора
//структур, описывающих точки.
